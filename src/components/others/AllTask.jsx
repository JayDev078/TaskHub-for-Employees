...
const AllTask = () => {
  ...
  return (
    <div className='bg-[#1C1C1C] p-5 mt-5 rounded h-35'>
      ...
      <div id='noscrollbar' className='h-35 overflow-auto'>
        {userData.map((elem, idx)=>{
          return <div key={idx} className='border-2 border-gray-300 py-2 px-4 flex justify-between mb-2'>
